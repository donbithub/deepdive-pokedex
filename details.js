...
//         StorageObj = data;
//     })
//     .then(() => SaveToLocalAndBack())
//     .then(() => {
//         if (document.body.id === "adminbody") {
//             PlaceProductsInPanel();
//         }
//         if (document.body.id === "webshopbody") {
//             PlaceElements();
//         }
//         if (document.body.id === "ordersbody") {
//             PlaceOrders();
//         }
...
//   .then((data) => {
//     StorageObj = data;
//     console.log("Random Pokémon:", data.name, data);
